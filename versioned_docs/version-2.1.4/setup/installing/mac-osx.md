...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.1.4/osx/10.8/riak-2.1.4-OSX-x86_64.tar.gz
...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.1.4/riak-2.1.4.tar.gz
