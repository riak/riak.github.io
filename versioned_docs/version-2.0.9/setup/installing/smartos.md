...
:::note SmartOS End of Life (EOL) for Riak KV 2.0.9
SmartOS is no longer supported in Riak KV 2.0.9+. If you are interested in using Riak KV on SmartOS, you can still [build from source](./source/index.md).
:::
...
```bash
curl -o /tmp/riak-2.0.9-SmartOS-x86_64.tgz http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.9/smartos/1.8/riak-2.0.9-SmartOS-x86_64.tgz
```
