...
Pre- and post-commit hooks are applied at the [bucket](../../learn/concepts/buckets.md) level,
...
Because hooks are defined at the bucket level, you can create [bucket types](../../developing/usage/bucket-types.md)
...
documentation on [object deletion](../../using/reference/object-deletion.md)) to determine whether a delete is
occurring.
