...
* Riak Control should be disabled throughout the rolling downgrade
  process
* [Configuration Files](../configuring/reference.md) must be replaced with those of the version
  being downgraded to
* [Active anti-entropy](../learn/concepts/active-anti-entropy.md) should be disabled if downgrading to a version
  below 1.3.
...
[`riak-admin`](../using/admin/riak-admin.md#reformat-indexes) documentation.
