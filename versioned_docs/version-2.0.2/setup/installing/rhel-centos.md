...
:::note Note: 2.0.2 not currently available**
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.2/rhel/5/riak-2.0.2-1.el5.x86_64.rpm
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.2/rhel/6/riak-2.0.2-1.el6.x86_64.rpm
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.2/riak-2.0.2.tar.gz
