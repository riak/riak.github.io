...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.2/osx/10.8/riak-2.0.2-OSX-x86_64.tar.gz
...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.2/riak-2.0.2.tar.gz
