...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.1.3/rhel/5/riak-2.1.3-1.el5.x86_64.rpm
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.1.3/rhel/6/riak-2.1.3-1.el6.x86_64.rpm
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.1.3/riak-2.1.3.tar.gz
