...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.6/osx/10.8/riak-2.0.6-OSX-x86_64.tar.gz
...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.6/riak-2.0.6.tar.gz
