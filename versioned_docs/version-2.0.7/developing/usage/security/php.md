...
security setup described [below](#php-client-basics). [Certificate](../../../using/security/managing-sources.md#certificate-based-authentication)-based authentication is not
