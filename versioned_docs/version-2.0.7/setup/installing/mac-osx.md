...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.7/osx/10.8/riak-2.0.7-OSX-x86_64.tar.gz
...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.7/riak-2.0.7.tar.gz
