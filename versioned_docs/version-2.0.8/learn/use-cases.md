...
[dev data model log data]: #log-data

[dev data model sensor data]: #sensor-data

[dev data model serve advertisements]: #serving-advertisements

[dev data model sess storage]: #session-storage

[dev data model user acct]: #user-accounts

[dev data model user events]: #user-events-and-timelines

[dev data model user settings]: #user-settings-and-preferences
...
tuning a database. Riak's tunable [apps replication properties](../developing/app-guide/replication-properties.md) can be set
...
data in Riak is opaque, with the exception of [Riak Data Types](../developing/data-types/index.md),
