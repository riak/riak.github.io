...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.8/ubuntu/lucid/riak_2.0.8-1_amd64.deb
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.8/ubuntu/natty/riak_2.0.8-1_amd64.deb
sudo dpkg -i riak_2.0.8-1_amd64.deb
```
...
```bash
wget http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.0.8/ubuntu/precise/riak_2.0.8-1_amd64.deb
sudo dpkg -i riak_2.0.8-1_amd64.deb
```
