...
[below](../../developing/app-guide/replication-properties.md#symbolic-consistency-names). Each
...
that they can be at the bucket level. You can use [bucket types](../../developing/usage/bucket-types.md)
...
check out the [section below](../../developing/app-guide/replication-properties.md#client-level-replication-settings)
...
documentation on [Bitcask](../../setup/planning/backend/bitcask.md), [LevelDB](../../setup/planning/backend/leveldb.md), and [multiple backends](../../setup/planning/backend/multi.md).
...
refer to the section on [development usage with Riak KV](../../developing/usage/index.md)
...
|:-----------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| All 3 nodes agree on the value                                                                                                                       | Once the first 2 vnodes return the value, that value is returned to the client                                                                                                                                                   |
