...
is Riak's [bucket types](../../using/reference/bucket-types.md) feature. This feature
...
made both to memory and to disk. Logical clocks, namely [dotted version vectors](../../learn/concepts/causal-context.md#dotted-version-vectors), are used in place of [vector clocks](../../learn/concepts/causal-context.md#vector-clocks) or timestamps to resolve value conflicts. Values stored as cluster metadata are opaque Erlang
