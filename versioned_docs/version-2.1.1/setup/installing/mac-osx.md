...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.1.1/osx/10.8/riak-2.1.1-OSX-x86_64.tar.gz
...
```bash
curl -O http://s3.amazonaws.com/downloads.basho.com/riak/2.2/2.1.1/riak-2.1.1.tar.gz
