...
based *only from the standpoint of connecting clients*. Like the CRDTs
on which they are based, the convergence logic is *state based* behind
...
**fields** of a map you can nest *any* of the five Data Types, including
...
essentially means that Data Type conflicts are *weighted* in a certain
...
perfect, particularly in that they do *not* guarantee [strong
