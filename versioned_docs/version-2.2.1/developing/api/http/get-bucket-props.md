...
bucket properties. See [Managing Bucket Types Through the Command Line](../../../using/reference/bucket-types.md#managing-bucket-types-through-the-command-line) for more details about reading bucket types using  the `riak-admin bucket-type` interface.
