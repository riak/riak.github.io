...
:::note SmartOS End of Life (EOL) for Riak KV 2.2.1
SmartOS is no longer supported in Riak KV 2.2.1+. If you are interested in using Riak KV on SmartOS, you can still [build from source](./source/index.md).
:::
