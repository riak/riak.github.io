...
[PBC Get Bucket Properties](/docs/developing/api/protocol-buffers/get-bucket-props) documentation.

You can also specify a [bucket type](/docs/developing/usage/bucket-types) using the
