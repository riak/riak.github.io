...
The JSON encoding is the same as [REST API](../../../developing/usage/mapreduce.md#data-object-input-commands) and
the external term format is the same as the [local Erlang API](../../../developing/app-guide/advanced-mapreduce.md#invoking-mapreduce)
