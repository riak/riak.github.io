...
The JSON encoding is the same as [REST API](../../../developing/usage/mapreduce.md#rest) and
the external term format is the same as the [local Erlang API](../../../developing/app-guide/advanced-mapreduce.md#erlang)
