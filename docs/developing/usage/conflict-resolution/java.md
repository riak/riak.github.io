---
title: "Java"
id: usage_conflict_resolution_java
slug: java
sidebar_position: 0
---
...
[bucket type](/docs/developing/usage/bucket-types) `siblings`, and for this bucket type
...
the official Java client library, in the [Developing with Riak KV: Usage](/docs/developing/usage) section.
