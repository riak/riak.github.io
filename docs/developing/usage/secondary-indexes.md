...
be used to find multiple objects in Riak. If you're storing [user data](../../learn/use-cases.md#user-accounts), for example, you could tag each object
...
[Riak Search](../../developing/usage/search.md) serves analogous purposes but is quite
...
* When you need more than the exact match and range searches that 2i
  supports. If that's the case, we recommend checking out [Riak Search](../../developing/usage/search.md).
