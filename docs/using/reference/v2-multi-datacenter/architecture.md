...
2. The site node in the secondary cluster initiates fullsync replication
   ...
   the primary cluster
3. The site and listener nodes iterate through each [vnode](../../../learn/glossary.md#vnode) in their respective clusters and compute a hash for
...
same [ring size](../../../learn/concepts/clusters.md#the-ring); if you are using fullsync
replication, every bucket's [`n_val`](../../../developing/app-guide/replication-properties.md#n-value-and-replication) must be the same in both the
